namespace LocalTranslateHub.Api.Pages;
...
<head>
  ...
  <title>LocalTranslateHub App</title>
  <style>
    :root {
      color-scheme: dark;
      --bg: #0b0d10;
...
<body>
  <div class="shell">
    <header class="topbar">
      <div class="brand"><span class="mark">OC</span><span>LocalTranslateHub</span></div>
  ...
  <script>
    ...
    async function boot() {
      try {
        ...
        appendMessage("result", "system", "LocalTranslateHub app ready", "boot");
      } catch (error) {
